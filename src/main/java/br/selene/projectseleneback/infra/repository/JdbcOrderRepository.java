...
//
//        List<ItemOrder> tickets = jdbc.query(itemsQuery, this::mapTicketOrder, orderId);
//
...
//
//    @Override
//    public List<ItemOrder> findItemsByOrderId(int orderId) {
//        return List.of();
//    }
//
//    private Order mapOrder(ResultSet rs, List<ItemOrder> tickets) throws SQLException {
...
//
//
//    private ItemOrder mapTicketOrder(ResultSet rs, int rowNum) throws SQLException {
